...
public final class PaintGUI extends JFrame {
    ...
    protected void start() {
        ...
        final ImageIcon icon = new ImageIcon("./files/brush_logo.png");
    ...
    private void createActions() {
        ...
        final Icon lineIcon = new ImageIcon("./files/line_bw.gif");
        final Icon rectangleIcon = new ImageIcon("./files/rectangle_bw.gif");
        final Icon ellipseIcon = new ImageIcon("./files/ellipse_bw.gif");
        final Icon pencilIcon = new ImageIcon("./files/pencil_bw.gif");
     ...
     * current state, these are the line, rectangle, and ellipse tools.
     * 
     * @author JJ Coldiron (jj.coldiron@outlook.com)
     * @version 1.0
     */
